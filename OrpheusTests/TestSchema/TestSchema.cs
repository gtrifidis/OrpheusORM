...
namespace OrpheusTests
{
    ...
    public class TestSchema
    {
        ...
        {
            var memberContactTypes = this.schema.AddSchemaTable(typeof(TestModelContactType));
        ...
        {
            this.schema = OrpheusCore.OrpheusIocContainer.Resolve<ISchema>(new ResolverOverride[] {
                new ParameterOverride("db",db),
